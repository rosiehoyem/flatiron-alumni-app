...
describe ForumsController do
  ...
  let(:valid_attributes) { { title: "Forum Title", content: "Forum Content" } }

  # This should return the minimal set of values that should be in the session
  # in order to pass any filters (e.g. authentication) defined in
  # ForumsController. Be sure to keep this updated too.
  let(:valid_session) { {email: "test@email.com", password: "password", employer: false} }
  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "redirects to the forums index" do
        post :create, {:forum => valid_attributes}, valid_session
